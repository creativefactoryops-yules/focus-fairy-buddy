...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BODY DOUBLE app by creativefactorystudio" },
      { name: "description", content: "A cute pixel girl and her pet mochi the cat - a body double, task organization  helping the NOTypical  brain execute tasks and finish projects." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "BODY DOUBLE app by creativefactorystudio" },
      { property: "og:description", content: "A cute pixel girl and her pet mochi the cat - a body double, task organization  helping the NOTypical  brain execute tasks and finish projects." },
